...
@ options passed:  -nostdinc -Iinclude -I./arch/arm/include -imultilib
@ armv4t -iprefix
@ /home/haobo/work/2440/tools/toolschain/bin/../lib/gcc/arm-none-linux-gnueabi/4.3.2/
@ -isysroot
@ /home/haobo/work/2440/tools/toolschain/bin/../arm-none-linux-gnueabi/libc
@ -D__KERNEL__ -D__UBOOT__ -D__ARM__ -DDO_DEPS_ONLY -DKBUILD_STR(s)=#s
@ -DKBUILD_BASENAME=KBUILD_STR(asm_offsets)
@ -DKBUILD_MODNAME=KBUILD_STR(asm_offsets) -isystem
@ /home/haobo/work/2440/tools/toolschain/bin/../lib/gcc/arm-none-linux-gnueabi/4.3.2/include
@ -include ./include/linux/kconfig.h -MD arch/arm/lib/.asm-offsets.s.d
@ arch/arm/lib/asm-offsets.c -march=armv4t -marm -mno-thumb-interwork
@ -mabi=aapcs-linux -mword-relocations -msoft-float -march=armv4t
...
.LASF57:
	.ascii	"/home/haobo/work/2440/boot/u-boot-2016.05\000"
.LASF29:
